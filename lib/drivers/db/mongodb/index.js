...
class keyonDriverMongoDB extends keyonDriverDB {
	 ...
	 * @param {keyonSchemaController} schema - Keyon Schema
	 * @override
	 */
	modelize(schema) {
		const self = this;
	 ...
	 *
	 * @param {keyonSchemaController} controller Schema reference to use
	 * @param {keyonPipeline} pipe Pipeline reference
	 * @param {Object} pipe.body Input informations
	 */
	create(controller, pipe, end) {
		// apply constraints
